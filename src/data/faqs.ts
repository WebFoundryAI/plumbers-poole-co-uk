...
export const PAGE_FAQS: FAQ[] = [
  {
    ...
    answer: 'We aim to respond to <a href="/services/emergency-drain-services/" class="text-primary hover:underline">emergency drainage callouts</a> within 60-90 minutes across <a href="/locations/poole/" class="text-primary hover:underline">Poole</a> and the surrounding Dorset area. Our team operates around the clock, so help is available whenever you need it, day or night.'
  },
  {
    question: "Do you charge a call-out fee?",
  ...
  },
  {
    ...
    answer: 'We provide drainage services throughout <a href="/locations/poole/" class="text-primary hover:underline">Poole</a> and the surrounding Dorset area, including <a href="/locations/bournemouth/" class="text-primary hover:underline">Bournemouth</a>, <a href="/locations/christchurch/" class="text-primary hover:underline">Christchurch</a>, <a href="/locations/wimborne/" class="text-primary hover:underline">Wimborne Minster</a>, Ferndown, Wareham, Ringwood, Swanage, Verwood, and Blandford Forum. See <a href="/locations/" class="text-primary hover:underline">all locations we cover</a>.'
  },
  {
